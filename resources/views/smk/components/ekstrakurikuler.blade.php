<section class="py-20 min-h-[600px] px-6 bg-white" id="ekstrakurikuler">
  ...
  @php
    $ekskul = [
      ['nama'=>'CITTER','deskripsi'=>'Citra Negara Theater','img'=>'/images/smk//citter.png','wa'=>'#','ig'=>'#','posisi'=>'left'],
      ['nama'=>'Futsal','deskripsi'=>'Ekstrakurikuler Futsal','img'=>'/images/smk/futsal.png','wa'=>'#','ig'=>'#','posisi'=>'right'],
      ['nama'=>'Paskibra','deskripsi'=>'Baswara','img'=>'/images/smk//paskibra.png','wa'=>'#','ig'=>'#','posisi'=>'left'],
      ['nama'=>'Cinar','deskripsi'=>'Seni Tari Citra Negara','img'=>'/images/smk/cinar.png','wa'=>'#','ig'=>'#','posisi'=>'right'],
    ];
  @endphp
